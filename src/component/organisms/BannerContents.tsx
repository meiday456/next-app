...
import {useMovieDetail, useMovieNowContents} from "@/hooks/query/queries/movueQueries";
import {AxiosError} from "axios";
import {Now} from "@/types/MovieType";
...
const BannerContents = (): ReactElement => {
    ...
    const {
        ...
        Math.floor(Math.random() * nowData?.results.length)
        ].id ?? 333339)
