...
export const useMovieNowContents = (options:UseQueryOptions<Now,AxiosError> = {}, onSuccess :()=>void = ()=>{}):UseQueryResult<Now,AxiosError>=>{
...
export const useMovieDetail = (options:UseQueryOptions<Detail,AxiosError> = {}, onSuccess :()=>void = ()=>{},id:number):UseQueryResult<Detail,AxiosError>=>{
    return useQuery({
